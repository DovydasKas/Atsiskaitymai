...
public class Savarankiskas {
		...
		while (true){
			...
			case 4://iraso salinimas
				...
				break;
                                ...
                                case 6://paieskos veiksmai
				B = surasti(A, n);
				System.out.println("Naujesni displejai uz nurodytus metus:");
	...
	//////////////////////////
        ...
        public static Displejus[] surasti (Displejus G[], int n){
            int x;
            BufferedReader in = new BufferedReader (new InputStreamReader (System.in));
                while (true){
		System.out.println("Iveskite metuus:");
		try {
		...
		Displejus A[] = new Displejus[1]; 
                
		//Displejus daugiau = G[0];
	...
	public static void spausdinti_sar_ekrane ( Displejus [] A, int n) {
		if (n > 0) {
			...
			System.out.println("* " + prailginti((i+1)+"", 3) +" * "+prailginti(A[i].gautiMarke(),15)+ " * "+ prailginti(A[i].gautiMetai()+"", 6)+" * " + prailginti(A[i].gautiKaina()+"", 6) + " * " + prailginti(A[i].gautiRaiska(), 15) + " *");
                        }
			System.out.println("*************************************************************");
		}
